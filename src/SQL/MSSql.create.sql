...
CREATE TABLE [Обращение] (
	 ...
	 [НаОснове_m0] UNIQUEIDENTIFIER  NULL,
...
CREATE TABLE [ApplicationLog] (
 ...
 ALTER TABLE [Обращение] ADD CONSTRAINT [Обращение_FСотрудник_0] FOREIGN KEY ([Сотрудник_m0]) REFERENCES [Сотрудник]
CREATE INDEX Обращение_IСотрудник_m0 on [Обращение] ([Сотрудник_m0])

 ALTER TABLE [Обращение] ADD CONSTRAINT [Обращение_FОбращение_0] FOREIGN KEY ([НаОснове_m0]) REFERENCES [Обращение]
CREATE INDEX Обращение_IНаОснове_m0 on [Обращение] ([НаОснове_m0])
